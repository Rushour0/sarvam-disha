  ...
  switch (audioVisualizerType) {
    case 'aura': {
      return (
        <MotionAgentAudioVisualizerAura
          ...
          themeMode={themeMode}
          className={cn('size-[220px] md:size-[360px] lg:size-[420px]', className)}
          {...props}
        />
      );
    }
      ...
      return (
        <motion.div className={className} {...props}>
          <MotionAgentAudioVisualizerWave
            ...
            className="size-[220px] md:size-[360px] lg:size-[420px]"
          />
        </motion.div>
      );
    }
    case 'grid': {
      ...
      return (
        <MotionAgentAudioVisualizerGrid
          ...
          className={cn(
            'size-[220px] gap-0 p-8 *:place-self-center md:size-[360px] lg:size-[420px]',
            className
          )}
          {...props}
        />
    ...
    default: {
      ...
      if (audioVisualizerBarCount <= 5) {
        size = 'xl';
        sizedClassName = cn(
          'size-[220px] gap-3 *:min-h-[40px] *:w-[40px] md:size-[360px] md:gap-4 md:*:min-h-[56px] md:*:w-[56px] lg:size-[420px]',
          className
        );
      } else if (audioVisualizerBarCount <= 10) {
        size = 'lg';
        sizedClassName = cn('size-[220px] md:size-[360px] lg:size-[420px]', className);
